          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              >
                ...
                <option value="Shree Shyamji Paddy Processing Pvt Ltd">Shree Shyamji Paddy Processing Pvt Ltd</option>
            ...
            <div>
              ...
              >
                ...
                <option value="PELLETS (8 MM RICE HUSK & GROUNDNUT)">PELLETS (8 MM RICE HUSK & GROUNDNUT)</option>
                <option value="PELLETS (16 MM GROUNDNUT)">PELLETS (16 MM GROUNDNUT)</option>
                <option value="PELLETS (16 MM RICE HUSK & GROUNDNUT)">PELLETS (16 MM RICE HUSK & GROUNDNUT)</option>
                ...
                <option value="BRIQUETTE (90 MM RICE HUSK & GROUNDNUT)">BRIQUETTE (90 MM RICE HUSK & GROUNDNUT)</option>
